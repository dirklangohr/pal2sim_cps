...
if __name__ == '__main__':
    ...
    for fold in range(1, 5):
        ...
        # print(f"train x shape: {train[0].shape}")
        # print(f"train y shape: {train[1].shape}")
        # print(f"val x shape: {val[0].shape}")
        # print(f"val y shape: {val[1].shape}")
        # print(f"test x shape: {test[0].shape}")
        # print(f"test y shape: {test[1].shape}")
